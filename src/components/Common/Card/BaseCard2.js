...
const lining = card_width / 100; // Control Image Border
const image_border = card_width / 25; //border thickness top bot
...
const font_size = image_width / 17;
const radius = image_width / 100;

const title_line_height = -trap_top/3; //shift title text
const Name_line_height = -image_width/13// shift name text

const card_border = image_width / 100;

const trap_color = "#000000";
const card_color = "#333333";


const image_border_top = image_width/12; // offset top from card
