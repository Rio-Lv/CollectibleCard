...
const image_border = card_width / 18; //border thickness top bot
...
const trap_side_thic = trap_width /8; // change trap Angle
...
const image_border_top = image_width/40; // offset top from card
const image_border_left = card_border + lining / 2; // offset left from card

const text_color = "#b9b9b9";

const imagebox_offset_top = image_width/12;//image position
