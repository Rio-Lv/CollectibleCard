...
const card_border_color = "#111111";
const innerborder_color = "#111111"

const card_inner_color = "#1b1b1b";
...
// trap main
const trap_h_thic = k / 13;
const trap_v_thic = k / 14;
...
// trap bot
const trapbot_bot = -k / 800; //k/1000 to avoid that on pixel line

// trap inner
const trap_h_thic_inner = trap_h_thic;
const trap_v_thic_inner = trap_v_thic;
...
//trap top inner
const traptop_top_inner = traptop_top - imagebox_edge / 2 - k / 400;
//trap bot inner
const trapbot_bot_inner = -imagebox_edge + k / 150;
...
const title_top = traptop_top_inner + k / 50;
const Name_bot = -k/120;
